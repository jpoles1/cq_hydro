...
mf = MasonFloor.from_instance(floor)
pf = PlantFloor.from_instance(floor)
cf = CrownFloor.from_instance(floor)
lf = LidFloor.from_instance(floor)
...
tower = assemble_tower([
    ...
    AssembleFloor(cf.sieve(), color=cq.Color(0,0.5,1,alpha), z_offset=-CrownFloor.from_instance(floor).floor_h, stl="stl/sieve.stl"),
